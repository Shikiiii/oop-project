    ...
    public static void InputProgrammer(){
        ...
        while(flag){
            ...
            switch (devType){
                ...
                case "devops":
                    System.out.println("Това са клиентите подходящи за вашата сфера:");
                    JobApp_Customer customerDevOps01 = new JobApp_Customer("Петър Илиев", "Трябва ми човек, който да потдържа сървърите в моята фирма", "Трябва ми чевек до 2 дни", "0888888888", "Месечна заплата от 3500лв. до 8000лв.");
        ...
        while (flag){
            ...
            switch (devType){
                case "web":
                    ...
                    JobApp_Programmer webDev01 = new JobApp_Programmer("Кирил Методиев", 20, "Web Developer", "PHP, HTML, CSS, JavaScript", "3 години" );
                    JobApp_Programmer webDev02 = new JobApp_Programmer("Валентин Вичев", 34, "Web Developer", "PHP, HTML, CSS, JavaScript", "13 години");
                    JobApp_Programmer webDev03 = new JobApp_Programmer("Виктория Гоцева", 26, "Web Developer", "PHP, HTML, CSS, JavaScript", "6 години");
                    webDev01.printInfo();
                    webDev02.printInfo();
                    webDev03.printInfo();
                    flag = false;
                ...
                case "game":
                    System.out.println("Това са наличните програмисти за вашите изисквания:");
                    JobApp_Programmer gameDev01 = new JobApp_Programmer("Милан Миланов ", 54, "Game Developer", "Lua, Java, C#", "36 години");
                    JobApp_Programmer gameDev02 = new JobApp_Programmer("Росен Стефанов", 31, "Game Developer", "C++, UnrealScript", "10 години");
                    JobApp_Programmer gameDev03 = new JobApp_Programmer("Цветан Цветанов", 23, "Game Developer", "Java, C#, UnrealScript", "4 години");
                    gameDev01.printInfo();
                    gameDev02.printInfo();
                    gameDev03.printInfo();
                    flag = false;
                ...
                case "devops":
                    System.out.println("Това са наличните програмисти за вашите изисквания:");
                    JobApp_Programmer devOps01 = new JobApp_Programmer("Елизабет Горанова", 25, "System Administrator", "Linux, C++", "6 години");
                    JobApp_Programmer devOps02 = new JobApp_Programmer("Петър Петров", 26, "System Administrator", "Linux, C++", "7 години");
                    JobApp_Programmer devOps03 = new JobApp_Programmer("Десислава Топузакова", 24, "System Administrator", "Linux, C++", "5 години");
                    devOps01.printInfo();
                    devOps02.printInfo();
                    devOps03.printInfo();
                    flag = false;
                ...
                case "mobile":
                    System.out.println("Това са наличните програмисти за вашите изисквания:");
                    JobApp_Programmer mobileDev01 = new JobApp_Programmer("Зорница Панайотова", 30, "Mobile Developer", "IOS, Android", "11 години");
                    JobApp_Programmer mobileDev02 = new JobApp_Programmer("Димитрина Стефанова", 22, "Mobile Developer", "IOS, Android", "3 години");
                    JobApp_Programmer mobileDev03 = new JobApp_Programmer("Велин Атанасов", 28, "Mobile Developer", "IOS, Android", "9 години");
